...
async function fetchAllBills() {
    try {
        const res   = await fetch('https://boardingms.onrender.com/api/bills/all-bills');
...
async function markAsPaid(studentId, billId) {
    ...
    try {
        const res    = await fetch('https://boardingms.onrender.com/api/bills/update-bill-status', {
            method: 'POST',
...
async function deleteBill(billId) {
    ...
    try {
        const res    = await fetch('https://boardingms.onrender.com/api/bills/delete-bill', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
...
async function triggerMonthlyBilling() {
    ...
    try {
        const now = new Date();
        const res = await fetch('https://boardingms.onrender.com/api/bills/generate-monthly', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
